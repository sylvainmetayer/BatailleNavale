...
public class BnavTextIHM {
	...
	private void menus(){
		...
		System.out.println("D = démarrer la partie");
		System.out.println("S = sauvegarder la partie");
		System.out.println("T = afficher score");
		System.out.println("Q = quitter le jeu");
		System.out.println("Saisissez les coordonnées de tir séparés par une virgule > ");
	}
	//construire affichage à partir du plateau qui est sur le jeu....
